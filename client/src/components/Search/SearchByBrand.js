...
function SearchByBrand() {
    ...
    const ExportModal = () => {
        const [tips] = useState([
            ...
            "Интересный факт: Вы можете просматривать позиции любого магазина с сайта wildberries",
            "Интересный факт: Все авто-выгрузки в Google таблицу осуществляются автоматически каждые 4 часа",
            ...
            "Информаци: Позиции товаров могут немного отличаться, так как сайт wildberries динамичный",
            "Интересный факт: Все авто-запросы на сайте осуществляются автоматически каждые 4 часа",
        ]);
