...
function SearchByArticle() {
    ...
    const ExportModal = () => {
        const [tips] = useState([
            ...
            "Интересный факт: Вы можете просматривать позиции конкурентов",
            ...
            "Интересный факт: Все авто-запросы и авто-выгрузки осуществляются автоматически каждые 4 часа",
        ]);
